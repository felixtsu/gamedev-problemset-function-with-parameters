...
// 请完成此函数，让玩家在按下上下左右按钮的时候
// 1. 角色可以向四个方向移动
// 2. 角色面向该方向
function turn (sprite: Sprite, direction: number, image2: Image) {
	
}
controller.left.onEvent(ControllerButtonEvent.Pressed, function () {
    turn(playerSprite, 3, img`
        . . . f f f f f . . . . 
        . . f e e e e e f f . . 
        . f e e e e e e e f f . 
